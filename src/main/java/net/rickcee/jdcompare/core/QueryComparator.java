...
public class QueryComparator {
	...
	public void executeReport(DBModel model)
		...
		try {
			...
			log.info("Error closing Connection 1: " + e.getMessage());
		}

		try {
			c2.close();
		} catch (Exception e) {
			log.info("Error closing Connection 2: " + e.getMessage());
		}
