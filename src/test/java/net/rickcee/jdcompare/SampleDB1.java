...
public class SampleDB1 {
    ...
    public static void main(String[] args) throws SQLException {
        String jdbcURL = "jdbc:h2:/Users/rickcee/sampledb1";
        ...
        String[] values = {
        		...
        		"insert into students (ID, name, age, address, phone) values (2, 'Erika', 27, '284 Palermo Street', '+54(911)4888-1945');",
        		...
        		"insert into trades (ID, cusip, quantity, price) values (2, '912828CE5', 450000, 99.1257);",
        		"insert into trades (ID, cusip, quantity, price) values (3, '912828CA3', 615000, 99.110);",
